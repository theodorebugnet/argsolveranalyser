...
int main(int argc, char** argv)
{
    ...
    {   //auto now = std::chrono::system_clock::now();
        ...
        std::cout << "Formatted runID: " << runId << "." << std::endl;
    }
    else
    ...
    {   //First, get the hash of the graph
        ...
        {   fs::path outfp = outdir / (fullproblem + ".output");
            ...
            std::cout << "First word buff: " << firstWordBuff << "." << std::endl;
            ...
            {   std::ifstream solif(solfp.c_str());
                ...
                if (verbose) std::cout << "SolWordBuff: " << solWordBuff << "; firstWordBuff: " << firstWordBuff << std::endl;
            }
            else //We need to compare extensions
            {   if (verbose) std::cout << "Running compare-extensions..." << std::endl;
                std::string binPath = "./compare-extensions";
            ...
            std::cout << "Correct: " << is_correct << "; total: " << total << "; correct: " << correct << "; wrong: " << wrong << "." << std::endl;
            //save to .stat here
