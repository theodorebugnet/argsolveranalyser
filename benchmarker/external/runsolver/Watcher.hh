...
#warning print the last history?
    ...
    if(varOutputFilename)
    {
      ...
      {          
        var << "WCTIME=" <<  execSummary.wcTime << endl;
        
        var << "CPUTIME=" << execSummary.cpuTime << endl;
        
        var << "MAXVM=" << execSummary.maxVM << endl;
 
        var << "TIMEOUT=" << boolalpha << execSummary.timeOut << endl;
      
        var << "MEMOUT=" << boolalpha << execSummary.memOut << endl;
